...
public class StatisticsHandler {
	...
	/**
	 * Computes the attack delay, Should be called with updateAnimationAtkHitTime
	 * to synchronize the attack and attack animation of the Character. 
	...
	private void computeAttackDelay() {
		...
		// For the manipulation of the atk delay
